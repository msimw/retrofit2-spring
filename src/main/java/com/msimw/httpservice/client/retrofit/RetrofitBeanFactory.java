package com.msimw.httpservice.client.retrofit;

import com.msimw.httpservice.client.annotation.HttpApi;
import com.msimw.httpservice.client.retrofit.json.FastJsonConverterFactory;
import com.msimw.httpservice.client.retrofit.log.LoggingInterceptor;
import com.msimw.httpservice.util.ResourcesUtil;
import okhttp3.*;
