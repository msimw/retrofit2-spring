...
import com.msimw.retrofit2x.retrofit.http.*;
...
public  class ServiceMethod<R, T> {
  ...
  static final class Builder<T, R> {
    ...
    private void parseMethodAnnotation(Annotation annotation) {
      ...
      } else if (annotation instanceof com.msimw.retrofit2x.retrofit.http.Headers) {
        String[] headersToParse = ((com.msimw.retrofit2x.retrofit.http.Headers) annotation).value();
